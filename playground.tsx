...
class textEditor {
  ...
  private saveState() {
    this.undoStack.push(
      new State(this.state.content, this.state.cursor, this.state.selectedSub)
    );
  }
  ...
  public append(str: string) {
    ...
    this.state.content = String.prototype.concat(
      this.state.content.slice(0, start),
      str,
  ...
  public backspace() {
    ...
    if (start == this.state.cursor) {
      this.state.content = String.prototype.concat(
        this.state.content.slice(0, start - 1),
        this.state.content.slice(this.state.cursor)
      );
  ...
  public select(from: string, to: string) {
    ...
    this.endIndex =
      parseInt(to) < this.state.content.length
        ? parseInt(to)
        : this.state.content.length;
    //set cursor
    this.state.cursor = this.endIndex;
    this.state.selectedSub = this.state.content.substring(
      this.startIndex,
      this.endIndex
    );
